window.addEventListener("load", () => {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            const api = `${proxy}http://api.openweathermap.org/geo/1.0/reverse?lat=${lat}&lon=${lon}&limit=${100}&appid=2ae4119c29e9679309e9100706dc8671`;
            ...
            fetch(api)
                ...
                .then(data => {
                    ...
                    const api2 = `${proxy}http://api.openweathermap.org/data/2.5/weather?q=${name}&appid=2ae4119c29e9679309e9100706dc8671`;
